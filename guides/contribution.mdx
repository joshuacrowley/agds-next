...
Patterns and components should offer value to multiple services or product teams before they will be considered for contribution to AgDS. Building, testing, and documenting a design system component or pattern takes time so a design that offers benefit to many teams will take priority.
